...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const isAdminUser = email === 'admin@habit.io';
      Swal.fire({
        icon: 'success',
        title: isAdminUser ? 'Welcome Admin!' : 'Welcome back!',
        text: isAdminUser ? 'Admin dashboard access granted.' : 'You have successfully logged in.',
        showConfirmButton: false,
        timer: 1500,
      });
      navigate(isAdminUser ? '/dashboard/admin' : '/dashboard');
    } catch (err) {
  ...
  const fillDemoCredentials = () => {
    setEmail('demo@habithub.com');
    setPassword('demo123');
    setErrors({});
  };

  const fillAdminCredentials = () => {
    setEmail('admin@habit.io');
    setPassword('admin@1122');
    setErrors({});
  };
        ...
        <div className="card p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Sign in to continue to HabitHub
            </p>
          </div>
